...
if __name__ == '__main__':
    ...
    beam1 = obj.reflect_beam(beam0=beam0, shpe=surf, tr=1)
    pts = [
        beam0.Location(), beam1.Location()
    ]
    for i in range(100):
        beam1 = obj.reflect_beam(beam0=beam1, shpe=surf, tr=0)
        pts.append(beam1.Location())
    ray = make_polygon(pts)

    obj.display.DisplayShape(surf, color="BLUE1", transparency=0.9)
