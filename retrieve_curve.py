...
def slicer2(event=None):
    ...
    for compound in compounds:
        # options: compose subshapes with orientation and location of aShape
        it = TopoDS_Iterator(compound, True, True)
        while it.More():
...
if __name__ == "__main__":
    ...
    add_function_to_menu("topology boolean operations", slicer1)
    add_function_to_menu("topology boolean operations", slicer2)
